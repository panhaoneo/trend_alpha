...
1. 全 A 财务筛选（**三率门槛**）：主报告期营收(销售)同比≥30% 且 归母净利同比≥40% 且 EPS同比≥30%（基本每股收益同报告期同比，来自利润表 `basic_eps`；无同期基数显示—），前一报告期净利≥40% 双期确认（排除 ST/北交所/科创板）
...
- 净利为归母净利润同比（同花顺指标）；EPS同比取自利润表 `basic_eps`（同报告期对上年同期，已处理股本摊薄差异），无同期基数(新股/扭亏)显示—；ROE 默认仅计分不做硬门槛（可配）
