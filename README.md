...
1. 全 A 财务筛选：主报告期归母净利同比≥40% 且 营收同比≥25%，前一报告期净利≥40% 双期确认（排除 ST/北交所/科创板）
2. 技术面：距 52 周高点、MA50/150/200、RS 代理（120日池内百分位）、放量比
3. 行业热度：同花顺 90 个一级行业「批量超预期」板块效应，标出热行业
4. 大盘方向（M）：上证/沪深300/创业板指 vs MA50/MA200
5. 输出分层清单：**A 景气核心α / B 接近一年新高 / C 回调观察 / 待观察**
6. 每只入选标的附 **财报 PDF + 招股书 PDF** 链接（巨潮资讯网，便于投研）
...
- 净利为归母净利润同比（同花顺指标）；ROE 默认仅计分不做硬门槛（可配）
